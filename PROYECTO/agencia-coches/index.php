...
require_once 'controllers/CocheController.php'; // incluimos la declaración de la Clase AlumnoController

$controller = new CocheController();            // creamos una instancia del controlador de alumno
